...
<figure>
    <img class="title-image" src="{{ site.image_location }}/diary/proj2_diary/12/ableton_sound_effect.png" alt="ableton effect">
</figure>
...
<div class="screenshot-list">
    <figure>
        <img class="title-image" src="{{ site.image_location }}/diary/proj2_diary/12/sfxr_screenshot.png" alt="sfxr">
    </figure>
    <figure>
        <img class="title-image" src="{{ site.image_location }}/diary/proj2_diary/12/bfxr_screenshot.png" alt="bfxr">
    </figure>
</div>
...
<figure>
    <img class="title-image" src="{{ site.image_location }}/diary/proj2_diary/12/tree_tone.png" alt="ableton tree tone">
</figure>
...
<figure>
    <img class="title-image" src="{{ site.image_location }}/diary/proj2_diary/12/BIC_2024.png" alt="BIC Festival 2024 - END FETCHERS">
</figure>
